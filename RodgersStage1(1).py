...
while 1:
    ...
    #These are the x,y,z components of the ball position
    #as defined by the partial kinematic equation:
    ball.x = ball.x + vx*dt #new x-component of the ball position
    ball.y = ball.y + vy*dt #new y-component of the ball position
    ball.z = ball.z + vz*dt #new z-component of the ball position
