...
for i in values3:
    ...
    while (state == True):
        ...
        F0x = F(bx,by,bz,vx,vy,vz,t,F0_mx,F0_my,F0_mz,1)
        F0y = F(bx,by,bz,vx,vy,vz,t,F0_mx,F0_my,F0_mz,2)
        F0z = F(bx,by,bz,vx,vy,vz,t,F0_mx,F0_my,F0_mz,3)
        ...
        Fgx = F(bxg,byg,bzg,vxg,vyg,vzg,t,F0_mx,F0_my,F0_mz,1)
        Fgy = F(bxg,byg,bzg,vxg,vyg,vzg,t,F0_mx,F0_my,F0_mz,2)
        Fgz = F(bxg,byg,bzg,vxg,vyg,vzg,t,F0_mx,F0_my,F0_mz,3)
